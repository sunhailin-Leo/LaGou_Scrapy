...
class LagouScrapyUserAgentMiddleware(UserAgentMiddleware):
    """
    设置User-Agent的Middleware
    """
    ...
    def process_request(self, request, spider):
        agent = random.choice(self._user_agent_list)
        request.headers['User-Agent'] = agent
        request.headers['Accept'] = 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'
        request.headers['Accept-Language'] = 'en-US,en;q=0.5'
        request.headers['Accept-Encoding'] = 'gzip, deflate'
        request.headers['Connection'] = 'keep-alive'
        request.headers['Referer'] = "'https://www.lagou.com/jobs/list_" + up.quote(settings['REFERER_NAME'])
